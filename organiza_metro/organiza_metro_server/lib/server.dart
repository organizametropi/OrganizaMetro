import 'package:organiza_metro_server/src/futureCall/verificar_alertas_futurecall.dart';
import 'package:serverpod/serverpod.dart';

import 'package:organiza_metro_server/src/web/routes/root.dart';
...
void run(List<String> args) async {
  ...
  pod.registerFutureCall(VerificarAlertasFutureCall(), 'verificarAlertas');

  //Authentication config Email validation
