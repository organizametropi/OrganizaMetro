...
CREATE TABLE "ferramenta" (
    ...
    "empenhadoParaId" bigint NOT NULL
);
...
CREATE TABLE "movimentacao" (
    ...
    "observacao" text,
    "origemBaseId" bigint NOT NULL,
    "destinoBaseId" bigint NOT NULL,
    "origemVeiculoId" bigint NOT NULL,
    "destinoVeiculoId" bigint NOT NULL
);
